 ...
 * @author Msys
 */
public class Isuue_Book2 extends javax.swing.JFrame {
   ...
   if (CheckDuplicateIssueID()==true){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Isuue_Book2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Isuue_Book2().setVisible(true);
            }
        });
    }
